...
# Circles test model
#INPUT_DIR='/home/sander/Documents/GIT/GitHub/FLAViz@svdhoog/FLAViz_parquet/test_models/circle/test_data/input/sql'
#OUTPUT_DIR='/home/sander/Documents/GIT/GitHub/FLAViz@svdhoog/FLAViz_parquet/test_models/circle/test_data/output/pqt'

# ABM small, sets 4-5 runs 1-2
INPUT_DIR='/home/sander/Documents/GIT/GitHub/FLAViz@svdhoog/FLAViz_parquet/sandbox_parquet_integration/test_models/ABM/test_data/data_input_1600_stable_gamma_12_for_5_cases_eurostat_firms_banks/sql'
OUTPUT_DIR='/home/sander/Documents/GIT/GitHub/FLAViz@svdhoog/FLAViz_parquet/sandbox_parquet_integration/test_models/ABM/test_data/data_input_1600_stable_gamma_12_for_5_cases_eurostat_firms_banks/pqt'
...
#OUTPUT_DIR='/home/sander/Documents/GIT/GitHub/FLAME-HPC/xparser@svdhoog/sandbox_parquet_integration/test_data/flat/calibration-mode-3-stage-1-sets-1-256-tarballs-part-1/pqt'
...
#echo "Data conversion from: $INPUT_DIR, writing Parquet files to: $OUTPUT_DIR"
...
##Test small:
#python sql_to_parquet.py --input $INPUT_DIR --output $OUTPUT_DIR --sets 1-4 --runs 1-2 --force

# Test medium-sized ABM:
#python sql_to_parquet.py --input $INPUT_DIR --output $OUTPUT_DIR --sets 4-5 --runs 1-2 --force
...
#INPUT_DIR='/home/sander/Documents/GIT/GitHub/FLAViz@svdhoog/FLAViz_parquet/test_models/circle/test_data/output/pqt_flat'
